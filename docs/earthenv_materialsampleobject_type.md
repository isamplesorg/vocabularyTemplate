...
- Concept URI token: atomprobetip
...
- Concept URI token: microtomeslice
...
- Concept URI token: mountedspecimen
...
- Concept URI token: polishedmountedspecimen
